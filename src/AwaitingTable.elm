module AwaitingTable exposing (awaitingTablesApiPart, createGame, getAwaitingTable, joinAwaitingTable, listAwaitingTables, postAwaitingTable, startAwaitingTable, userCheckTooOld)
